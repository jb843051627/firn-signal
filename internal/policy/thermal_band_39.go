...
func NewThermalBand39() ThermalBand39 {
	return ThermalBand39{Label: "firn-band-39", DepthMin: 38.0, DepthMax: 468.0, TemperatureMin: -36.0, TemperatureMax: -11.0, Weight: 1.4}
}

func (b ThermalBand39) Name() string { return b.Label }

func (b ThermalBand39) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand39) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand39) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand39) Score(depth, temperature float64) float64 {
...
func (b ThermalBand39) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand39) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand39) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand39) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand39) GradientLimit(profile model.ThermalProfile) bool {
