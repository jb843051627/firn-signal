...
func NewThermalBand35() ThermalBand35 {
	return ThermalBand35{Label: "firn-band-35", DepthMin: 34.0, DepthMax: 420.0, TemperatureMin: -37.0, TemperatureMax: -11.0, Weight: 1.9}
}

func (b ThermalBand35) Name() string { return b.Label }

func (b ThermalBand35) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand35) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand35) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand35) Score(depth, temperature float64) float64 {
...
func (b ThermalBand35) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand35) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand35) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand35) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand35) GradientLimit(profile model.ThermalProfile) bool {
