...
func NewThermalBand04() ThermalBand04 {
	return ThermalBand04{Label: "firn-band-04", DepthMin: 3.0, DepthMax: 48.0, TemperatureMin: -44.0, TemperatureMax: -18.0, Weight: 1.5}
}

func (b ThermalBand04) Name() string { return b.Label }

func (b ThermalBand04) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand04) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand04) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand04) Score(depth, temperature float64) float64 {
...
func (b ThermalBand04) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand04) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand04) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand04) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand04) GradientLimit(profile model.ThermalProfile) bool {
