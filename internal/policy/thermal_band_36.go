...
func NewThermalBand36() ThermalBand36 {
	return ThermalBand36{Label: "firn-band-36", DepthMin: 35.0, DepthMax: 432.0, TemperatureMin: -36.0, TemperatureMax: -11.0, Weight: 1.1}
}

func (b ThermalBand36) Name() string { return b.Label }

func (b ThermalBand36) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand36) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand36) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand36) Score(depth, temperature float64) float64 {
...
func (b ThermalBand36) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand36) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand36) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand36) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand36) GradientLimit(profile model.ThermalProfile) bool {
