...
func NewThermalBand13() ThermalBand13 {
	return ThermalBand13{Label: "firn-band-13", DepthMin: 12.0, DepthMax: 156.0, TemperatureMin: -42.0, TemperatureMax: -16.0, Weight: 1.5}
}

func (b ThermalBand13) Name() string { return b.Label }

func (b ThermalBand13) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand13) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand13) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand13) Score(depth, temperature float64) float64 {
...
func (b ThermalBand13) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand13) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand13) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand13) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand13) GradientLimit(profile model.ThermalProfile) bool {
