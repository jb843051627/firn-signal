...
func NewThermalBand06() ThermalBand06 {
	return ThermalBand06{Label: "firn-band-06", DepthMin: 5.0, DepthMax: 72.0, TemperatureMin: -44.0, TemperatureMax: -17.0, Weight: 1.7}
}

func (b ThermalBand06) Name() string { return b.Label }

func (b ThermalBand06) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand06) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand06) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand06) Score(depth, temperature float64) float64 {
...
func (b ThermalBand06) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand06) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand06) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand06) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand06) GradientLimit(profile model.ThermalProfile) bool {
