...
func NewThermalBand38() ThermalBand38 {
	return ThermalBand38{Label: "firn-band-38", DepthMin: 37.0, DepthMax: 456.0, TemperatureMin: -36.0, TemperatureMax: -11.0, Weight: 1.3}
}

func (b ThermalBand38) Name() string { return b.Label }

func (b ThermalBand38) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand38) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand38) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand38) Score(depth, temperature float64) float64 {
...
func (b ThermalBand38) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand38) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand38) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand38) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand38) GradientLimit(profile model.ThermalProfile) bool {
