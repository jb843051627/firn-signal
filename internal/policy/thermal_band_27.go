...
func NewThermalBand27() ThermalBand27 {
	return ThermalBand27{Label: "firn-band-27", DepthMin: 26.0, DepthMax: 324.0, TemperatureMin: -39.0, TemperatureMax: -13.0, Weight: 1.1}
}

func (b ThermalBand27) Name() string { return b.Label }

func (b ThermalBand27) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand27) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand27) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand27) Score(depth, temperature float64) float64 {
...
func (b ThermalBand27) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand27) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand27) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand27) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand27) GradientLimit(profile model.ThermalProfile) bool {
