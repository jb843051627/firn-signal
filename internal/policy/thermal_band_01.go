...
func NewThermalBand01() ThermalBand01 {
	return ThermalBand01{Label: "firn-band-01", DepthMin: 0.0, DepthMax: 12.0, TemperatureMin: -45.0, TemperatureMax: -18.0, Weight: 1.2}
}

func (b ThermalBand01) Name() string { return b.Label }

func (b ThermalBand01) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand01) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand01) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand01) Score(depth, temperature float64) float64 {
...
func (b ThermalBand01) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand01) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand01) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand01) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand01) GradientLimit(profile model.ThermalProfile) bool {
