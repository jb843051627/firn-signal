...
func NewThermalBand03() ThermalBand03 {
	return ThermalBand03{Label: "firn-band-03", DepthMin: 2.0, DepthMax: 36.0, TemperatureMin: -45.0, TemperatureMax: -18.0, Weight: 1.4}
}

func (b ThermalBand03) Name() string { return b.Label }

func (b ThermalBand03) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand03) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand03) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand03) Score(depth, temperature float64) float64 {
...
func (b ThermalBand03) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand03) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand03) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand03) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand03) GradientLimit(profile model.ThermalProfile) bool {
