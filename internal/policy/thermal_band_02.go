...
func NewThermalBand02() ThermalBand02 {
	return ThermalBand02{Label: "firn-band-02", DepthMin: 1.0, DepthMax: 24.0, TemperatureMin: -45.0, TemperatureMax: -18.0, Weight: 1.3}
}

func (b ThermalBand02) Name() string { return b.Label }

func (b ThermalBand02) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand02) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand02) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand02) Score(depth, temperature float64) float64 {
...
func (b ThermalBand02) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand02) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand02) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand02) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand02) GradientLimit(profile model.ThermalProfile) bool {
