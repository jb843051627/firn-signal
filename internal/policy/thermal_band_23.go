...
func NewThermalBand23() ThermalBand23 {
	return ThermalBand23{Label: "firn-band-23", DepthMin: 22.0, DepthMax: 276.0, TemperatureMin: -40.0, TemperatureMax: -14.0, Weight: 1.6}
}

func (b ThermalBand23) Name() string { return b.Label }

func (b ThermalBand23) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand23) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand23) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand23) Score(depth, temperature float64) float64 {
...
func (b ThermalBand23) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand23) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand23) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand23) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand23) GradientLimit(profile model.ThermalProfile) bool {
