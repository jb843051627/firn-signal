...
func NewThermalBand32() ThermalBand32 {
	return ThermalBand32{Label: "firn-band-32", DepthMin: 31.0, DepthMax: 384.0, TemperatureMin: -37.0, TemperatureMax: -12.0, Weight: 1.6}
}

func (b ThermalBand32) Name() string { return b.Label }

func (b ThermalBand32) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand32) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand32) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand32) Score(depth, temperature float64) float64 {
...
func (b ThermalBand32) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand32) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand32) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand32) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand32) GradientLimit(profile model.ThermalProfile) bool {
