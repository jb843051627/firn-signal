...
func NewThermalBand31() ThermalBand31 {
	return ThermalBand31{Label: "firn-band-31", DepthMin: 30.0, DepthMax: 372.0, TemperatureMin: -38.0, TemperatureMax: -12.0, Weight: 1.5}
}

func (b ThermalBand31) Name() string { return b.Label }

func (b ThermalBand31) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand31) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand31) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand31) Score(depth, temperature float64) float64 {
...
func (b ThermalBand31) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand31) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand31) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand31) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand31) GradientLimit(profile model.ThermalProfile) bool {
