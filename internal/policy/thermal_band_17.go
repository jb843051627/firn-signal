...
func NewThermalBand17() ThermalBand17 {
	return ThermalBand17{Label: "firn-band-17", DepthMin: 16.0, DepthMax: 204.0, TemperatureMin: -41.0, TemperatureMax: -15.0, Weight: 1.9}
}

func (b ThermalBand17) Name() string { return b.Label }

func (b ThermalBand17) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand17) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand17) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand17) Score(depth, temperature float64) float64 {
...
func (b ThermalBand17) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand17) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand17) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand17) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand17) GradientLimit(profile model.ThermalProfile) bool {
