...
func NewThermalBand25() ThermalBand25 {
	return ThermalBand25{Label: "firn-band-25", DepthMin: 24.0, DepthMax: 300.0, TemperatureMin: -39.0, TemperatureMax: -13.0, Weight: 1.8}
}

func (b ThermalBand25) Name() string { return b.Label }

func (b ThermalBand25) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand25) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand25) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand25) Score(depth, temperature float64) float64 {
...
func (b ThermalBand25) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand25) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand25) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand25) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand25) GradientLimit(profile model.ThermalProfile) bool {
