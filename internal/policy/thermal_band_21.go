...
func NewThermalBand21() ThermalBand21 {
	return ThermalBand21{Label: "firn-band-21", DepthMin: 20.0, DepthMax: 252.0, TemperatureMin: -40.0, TemperatureMax: -14.0, Weight: 1.4}
}

func (b ThermalBand21) Name() string { return b.Label }

func (b ThermalBand21) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand21) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand21) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand21) Score(depth, temperature float64) float64 {
...
func (b ThermalBand21) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand21) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand21) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand21) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand21) GradientLimit(profile model.ThermalProfile) bool {
