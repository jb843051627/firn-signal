...
func NewThermalBand12() ThermalBand12 {
	return ThermalBand12{Label: "firn-band-12", DepthMin: 11.0, DepthMax: 144.0, TemperatureMin: -42.0, TemperatureMax: -16.0, Weight: 1.4}
}

func (b ThermalBand12) Name() string { return b.Label }

func (b ThermalBand12) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand12) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand12) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand12) Score(depth, temperature float64) float64 {
...
func (b ThermalBand12) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand12) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand12) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand12) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand12) GradientLimit(profile model.ThermalProfile) bool {
