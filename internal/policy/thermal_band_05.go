...
func NewThermalBand05() ThermalBand05 {
	return ThermalBand05{Label: "firn-band-05", DepthMin: 4.0, DepthMax: 60.0, TemperatureMin: -44.0, TemperatureMax: -17.0, Weight: 1.6}
}

func (b ThermalBand05) Name() string { return b.Label }

func (b ThermalBand05) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand05) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand05) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand05) Score(depth, temperature float64) float64 {
...
func (b ThermalBand05) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand05) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand05) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand05) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand05) GradientLimit(profile model.ThermalProfile) bool {
