...
func NewThermalBand24() ThermalBand24 {
	return ThermalBand24{Label: "firn-band-24", DepthMin: 23.0, DepthMax: 288.0, TemperatureMin: -39.0, TemperatureMax: -14.0, Weight: 1.7}
}

func (b ThermalBand24) Name() string { return b.Label }

func (b ThermalBand24) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand24) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand24) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand24) Score(depth, temperature float64) float64 {
...
func (b ThermalBand24) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand24) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand24) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand24) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand24) GradientLimit(profile model.ThermalProfile) bool {
