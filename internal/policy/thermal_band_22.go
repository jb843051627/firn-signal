...
func NewThermalBand22() ThermalBand22 {
	return ThermalBand22{Label: "firn-band-22", DepthMin: 21.0, DepthMax: 264.0, TemperatureMin: -40.0, TemperatureMax: -14.0, Weight: 1.5}
}

func (b ThermalBand22) Name() string { return b.Label }

func (b ThermalBand22) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand22) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand22) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand22) Score(depth, temperature float64) float64 {
...
func (b ThermalBand22) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand22) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand22) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand22) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand22) GradientLimit(profile model.ThermalProfile) bool {
