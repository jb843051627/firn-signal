...
func NewThermalBand37() ThermalBand37 {
	return ThermalBand37{Label: "firn-band-37", DepthMin: 36.0, DepthMax: 444.0, TemperatureMin: -36.0, TemperatureMax: -11.0, Weight: 1.2}
}

func (b ThermalBand37) Name() string { return b.Label }

func (b ThermalBand37) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand37) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand37) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand37) Score(depth, temperature float64) float64 {
...
func (b ThermalBand37) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand37) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand37) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand37) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand37) GradientLimit(profile model.ThermalProfile) bool {
