...
func NewThermalBand09() ThermalBand09 {
	return ThermalBand09{Label: "firn-band-09", DepthMin: 8.0, DepthMax: 108.0, TemperatureMin: -43.0, TemperatureMax: -17.0, Weight: 1.1}
}

func (b ThermalBand09) Name() string { return b.Label }

func (b ThermalBand09) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand09) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand09) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand09) Score(depth, temperature float64) float64 {
...
func (b ThermalBand09) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand09) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand09) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand09) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand09) GradientLimit(profile model.ThermalProfile) bool {
