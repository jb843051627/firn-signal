...
func NewThermalBand26() ThermalBand26 {
	return ThermalBand26{Label: "firn-band-26", DepthMin: 25.0, DepthMax: 312.0, TemperatureMin: -39.0, TemperatureMax: -13.0, Weight: 1.9}
}

func (b ThermalBand26) Name() string { return b.Label }

func (b ThermalBand26) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand26) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand26) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand26) Score(depth, temperature float64) float64 {
...
func (b ThermalBand26) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand26) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand26) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand26) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand26) GradientLimit(profile model.ThermalProfile) bool {
