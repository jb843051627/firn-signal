...
func NewThermalBand40() ThermalBand40 {
	return ThermalBand40{Label: "firn-band-40", DepthMin: 39.0, DepthMax: 480.0, TemperatureMin: -35.0, TemperatureMax: -10.0, Weight: 1.5}
}

func (b ThermalBand40) Name() string { return b.Label }

func (b ThermalBand40) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand40) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand40) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand40) Score(depth, temperature float64) float64 {
...
func (b ThermalBand40) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand40) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand40) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand40) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand40) GradientLimit(profile model.ThermalProfile) bool {
