...
func NewThermalBand10() ThermalBand10 {
	return ThermalBand10{Label: "firn-band-10", DepthMin: 9.0, DepthMax: 120.0, TemperatureMin: -43.0, TemperatureMax: -16.0, Weight: 1.2}
}

func (b ThermalBand10) Name() string { return b.Label }

func (b ThermalBand10) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand10) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand10) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand10) Score(depth, temperature float64) float64 {
...
func (b ThermalBand10) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand10) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand10) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand10) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand10) GradientLimit(profile model.ThermalProfile) bool {
