...
func NewThermalBand07() ThermalBand07 {
	return ThermalBand07{Label: "firn-band-07", DepthMin: 6.0, DepthMax: 84.0, TemperatureMin: -44.0, TemperatureMax: -17.0, Weight: 1.8}
}

func (b ThermalBand07) Name() string { return b.Label }

func (b ThermalBand07) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand07) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand07) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand07) Score(depth, temperature float64) float64 {
...
func (b ThermalBand07) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand07) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand07) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand07) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand07) GradientLimit(profile model.ThermalProfile) bool {
