...
func NewThermalBand19() ThermalBand19 {
	return ThermalBand19{Label: "firn-band-19", DepthMin: 18.0, DepthMax: 228.0, TemperatureMin: -41.0, TemperatureMax: -15.0, Weight: 1.2}
}

func (b ThermalBand19) Name() string { return b.Label }

func (b ThermalBand19) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand19) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand19) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand19) Score(depth, temperature float64) float64 {
...
func (b ThermalBand19) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand19) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand19) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand19) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand19) GradientLimit(profile model.ThermalProfile) bool {
