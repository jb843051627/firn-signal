...
func NewThermalBand14() ThermalBand14 {
	return ThermalBand14{Label: "firn-band-14", DepthMin: 13.0, DepthMax: 168.0, TemperatureMin: -42.0, TemperatureMax: -16.0, Weight: 1.6}
}

func (b ThermalBand14) Name() string { return b.Label }

func (b ThermalBand14) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand14) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand14) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand14) Score(depth, temperature float64) float64 {
...
func (b ThermalBand14) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand14) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand14) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand14) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand14) GradientLimit(profile model.ThermalProfile) bool {
