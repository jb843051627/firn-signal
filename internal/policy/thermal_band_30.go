...
func NewThermalBand30() ThermalBand30 {
	return ThermalBand30{Label: "firn-band-30", DepthMin: 29.0, DepthMax: 360.0, TemperatureMin: -38.0, TemperatureMax: -12.0, Weight: 1.4}
}

func (b ThermalBand30) Name() string { return b.Label }

func (b ThermalBand30) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand30) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand30) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand30) Score(depth, temperature float64) float64 {
...
func (b ThermalBand30) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand30) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand30) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand30) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand30) GradientLimit(profile model.ThermalProfile) bool {
