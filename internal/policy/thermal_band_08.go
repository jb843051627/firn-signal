...
func NewThermalBand08() ThermalBand08 {
	return ThermalBand08{Label: "firn-band-08", DepthMin: 7.0, DepthMax: 96.0, TemperatureMin: -43.0, TemperatureMax: -17.0, Weight: 1.9}
}

func (b ThermalBand08) Name() string { return b.Label }

func (b ThermalBand08) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand08) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand08) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand08) Score(depth, temperature float64) float64 {
...
func (b ThermalBand08) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand08) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand08) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand08) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand08) GradientLimit(profile model.ThermalProfile) bool {
