...
func NewThermalBand28() ThermalBand28 {
	return ThermalBand28{Label: "firn-band-28", DepthMin: 27.0, DepthMax: 336.0, TemperatureMin: -38.0, TemperatureMax: -13.0, Weight: 1.2}
}

func (b ThermalBand28) Name() string { return b.Label }

func (b ThermalBand28) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand28) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand28) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand28) Score(depth, temperature float64) float64 {
...
func (b ThermalBand28) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand28) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand28) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand28) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand28) GradientLimit(profile model.ThermalProfile) bool {
