...
func NewThermalBand18() ThermalBand18 {
	return ThermalBand18{Label: "firn-band-18", DepthMin: 17.0, DepthMax: 216.0, TemperatureMin: -41.0, TemperatureMax: -15.0, Weight: 1.1}
}

func (b ThermalBand18) Name() string { return b.Label }

func (b ThermalBand18) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand18) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand18) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand18) Score(depth, temperature float64) float64 {
...
func (b ThermalBand18) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand18) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand18) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand18) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand18) GradientLimit(profile model.ThermalProfile) bool {
