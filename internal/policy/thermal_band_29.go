...
func NewThermalBand29() ThermalBand29 {
	return ThermalBand29{Label: "firn-band-29", DepthMin: 28.0, DepthMax: 348.0, TemperatureMin: -38.0, TemperatureMax: -13.0, Weight: 1.3}
}

func (b ThermalBand29) Name() string { return b.Label }

func (b ThermalBand29) Contains(depth, temperature float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax && temperature >= b.TemperatureMin && temperature <= b.TemperatureMax
}

func (b ThermalBand29) DepthContains(depth float64) bool {
	return depth >= b.DepthMin && depth <= b.DepthMax
}

func (b ThermalBand29) Distance(depth, temperature float64) float64 {
	depthGap := 0.0
	if depth < b.DepthMin {
...
func (b ThermalBand29) Score(depth, temperature float64) float64 {
...
func (b ThermalBand29) Signal(profile model.ThermalProfile) model.Signal {
...
func (b ThermalBand29) Explain(depth, temperature float64) string {
	return fmt.Sprintf("%s depth=%.2f temperature=%.2f distance=%.2f", b.Label, depth, temperature, b.Distance(depth, temperature))
}

func (b ThermalBand29) Select(points []model.ProfilePoint) []model.ProfilePoint {
...
func (b ThermalBand29) Average(points []model.ProfilePoint) float64 {
...
func (b ThermalBand29) GradientLimit(profile model.ThermalProfile) bool {
